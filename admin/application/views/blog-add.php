                    ...
                    <form id="basic-form" method="post" enctype="multipart/form-data" validate>
                        <div class="body">
                            ...
                            <label for=""><small>Blog Title</small></label><br>
                                <input type="text" class="form-control" placeholder="Enter Blog title" name="blogTitle" required/>
                            </div>
                            <div class="form-group">
                            ...
                            <label for=""><small>Meta Description</small></label><br>
                                <textarea id="" class="form-control" cols="165" rows="3" name="metaDescription" required></textarea>
                            </div>
                            <div class="form-group">
                            <label for=""><small>Keywords</small></label><br>
                                <textarea id="" class="form-control" cols="165" rows="3" name="metaKeywords" required></textarea>
                            </div>
                            ...
                            <textarea class="summernote" id="" cols="30" rows="10" name="description" required></textarea><br>
