            ...
            <div class="col">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center bg-transparent p-0 m-0">
                        ...
                        <li class="breadcrumb-item active text-primary" aria-current="page">API Integration</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-lg-6 mb-6 mb-lg-0 order-lg-1">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            <img src="assets/images/about/12.jpg" class="img-fluid rounded shadow-lg mt-10" alt="...">
                        </div>
                ...
                <div class="col-12 col-lg-6 col-xl-5">
                    <div> <span class="badge badge-primary-soft p-2">
                        ...
                        <h2 class="mt-3 font-w-5">Bootsland Small Team Crafting Beautiful Experience</h2>
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="container">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-12 col-lg-6 col-xl-5">
                                <div class="mb-5">
                                    <h2 class="mt-3 font-w-5">Hire a Team not a developer</h2>
                                    <p class="lead">Our team of experts has specialized in different areas to meet the requirements in different projects.</p>
                                </div>
                                <div class="">
                                    <div class="mb-3">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <p class="mb-0 ml-3">As a team we aim to deliver world class products.</p>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <p class="mb-0 ml-3">Our team offer topmost priority to the Quality.</p>
                                        </div>
                                    </div>
